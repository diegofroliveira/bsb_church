...
insert into auth.users (
  ...
  ('00000000-0000-0000-0000-000000000000', 'dddddddd-dddd-4ddd-8ddd-ddddddddddd1', 'authenticated', 'authenticated', 'multi-tenant@example.invalid', extensions.crypt('synthetic-password', extensions.gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{}', now(), now(), '', '', '', ''),
  ('00000000-0000-0000-0000-000000000000', 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeee1', 'authenticated', 'authenticated', 'without-membership@example.invalid', extensions.crypt('synthetic-password', extensions.gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{}', now(), now(), '', '', '', '')
...
insert into public.user_profiles(id, display_name) values
  ...
  ('dddddddd-dddd-4ddd-8ddd-ddddddddddd1', 'Usuário Multitenant'),
  ('eeeeeeee-eeee-4eee-8eee-eeeeeeeeeee1', 'Usuário sem Membership')
on conflict (id) do nothing;
...
insert into public.tenant_memberships(id, tenant_id, user_id, status, joined_at) values
  ...
  ('55000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'dddddddd-dddd-4ddd-8ddd-ddddddddddd1', 'active', now()),
  ('55000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002', 'dddddddd-dddd-4ddd-8ddd-ddddddddddd1', 'active', now())
on conflict (id) do nothing;
...
insert into public.access_assignments(id, tenant_id, membership_id, role_id, org_unit_id) values
  ...
  ('75000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '55000000-0000-4000-8000-000000000001', '61000000-0000-4000-8000-000000000001', null),
  ('75000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002', '55000000-0000-4000-8000-000000000002', '62000000-0000-4000-8000-000000000001', null)
on conflict (id) do nothing;
